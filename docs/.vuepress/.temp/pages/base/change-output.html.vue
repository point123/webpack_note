<template><div><h1>修改输出资源的名称和路径</h1>
...
<span class="line">        <span class="token comment">// js文件输出目录</span></span>
...
<span class="line">                        <span class="token literal-property property">maxSize</span><span class="token operator">:</span> <span class="token number">103</span> <span class="token operator">*</span> <span class="token number">1024</span> <span class="token comment">// 小于103kb的图片将会被base64处理</span></span>
<span class="line">                    <span class="token punctuation">}</span></span>
<span class="line">                <span class="token punctuation">}</span><span class="token punctuation">,</span></span>
...
<span class="line highlighted">                    <span class="token comment">// 指定图片输出目录并指定输出名</span></span>
<span class="line highlighted">                    <span class="token comment">// [hash]: 哈希值</span></span>
<span class="line highlighted">                    <span class="token comment">// [hash:10]: 取哈希值前10位</span></span>
<span class="line highlighted">                    <span class="token comment">// [ext]: 文件扩展名</span></span>
<span class="line highlighted">                    <span class="token comment">// [query]: query参数</span></span>
<span class="line highlighted">                    <span class="token literal-property property">filename</span><span class="token operator">:</span> <span class="token string">"static/images/[hash][ext][query]"</span></span>
...
<p>注意修改index目录中引用的js文件路径</p>
</div>
<p>dist输出目录</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre class="language-text"><code><span class="line">dist</span>
<span class="line">|——static</span>
<span class="line">|   |——js</span>
<span class="line">|   |   |——main.js</span>
<span class="line">|   |——images</span>
<span class="line">|___|___|——7023ac25b3.png</span>
<span class="line"></span></code></pre>
